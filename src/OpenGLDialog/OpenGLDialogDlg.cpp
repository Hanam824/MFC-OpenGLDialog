...
COpenGLDialogDlg::COpenGLDialogDlg(CWnd* pParent /*=nullptr*/)
...
BEGIN_MESSAGE_MAP(COpenGLDialogDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_CAPTURE, &COpenGLDialogDlg::OnBnClickedButtonCapture)
END_MESSAGE_MAP()
...
BOOL COpenGLDialogDlg::OnInitDialog()
{
	...
	CRect rect;
	GetDlgItem(IDC_STATIC_OPENGL_WINDOW)->GetWindowRect(rect);
	ScreenToClient(&rect);
	glControl.Create(rect, this);

	return TRUE;  // return TRUE  unless you set the focus to a control
}

void COpenGLDialogDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void COpenGLDialogDlg::OnBnClickedButtonCapture()
{
