...
// OpenGLDialog.cpp : Defines the class behaviors for the application.
//
...
// The one and only COpenGLDialogApp object

COpenGLDialogApp theApp;


// COpenGLDialogApp initialization
